...
| FR-2.3 | Defaults to slot `440522383`; **Load** contention |
| FR-3 | Token dropdown is **candle mints only**; 1m/5m options match that mint |
...
want the FINDINGS §5 “before” case (see `cli` `--help`).
